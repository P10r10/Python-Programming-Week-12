...
def sort_by_number_of_routes(areas: list[ClimbingArea]) -> list[ClimbingArea]:
    def by_number_of_routes(ca: ClimbingArea):
        return ca.routes()
    return sorted(areas, key=by_number_of_routes)


def sort_by_most_difficult(areas: list[ClimbingArea]) -> list[ClimbingArea]:
    def by_most_difficult(ca: ClimbingArea):
